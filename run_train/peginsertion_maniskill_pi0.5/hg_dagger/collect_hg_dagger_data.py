...
_HG_DAGGER_PARENT = osp.abspath(osp.join(osp.dirname(__file__), ".."))
if REPO_PATH not in sys.path:
    sys.path.insert(0, REPO_PATH)
if _HG_DAGGER_PARENT not in sys.path:
    sys.path.insert(0, _HG_DAGGER_PARENT)
...
ROBOFPE = os.environ.get("RLINF_ROBOFPE_PATH", "/home/yingxi/RoboFAC/mani_envs")
