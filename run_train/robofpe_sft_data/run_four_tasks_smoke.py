...
BASE = Path("/data/yingxi/datasets/robofpe_sft/smoke_4tasks_20260920")
TASKS = [("PegInsertionVertical-v1", 0), ("UprightStack-v1", 0),
         ("PegInsertionSide-v1", 0), ("PullCubeTool-golf", 0)]
TARGET = 4
converters = []
