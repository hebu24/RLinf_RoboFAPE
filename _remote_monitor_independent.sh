...
last1=43  # GPU01 current step
last2=20  # delta resumed from step 20 (warmup=20, assertion-fixed)
...
while true; do
  ...
  # crash guard
  for s in rl_abs_independent_window_gpu01 rl_delta_indep_resume20_w20_gpu23; do
