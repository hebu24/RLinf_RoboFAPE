...
from rlinf.models.embodiment.openpi.dataconfig.maniskill_dataconfig import (
    ...
    LeRobotManiSkillPegInsertionDataConfig,
    LeRobotManiSkillPegInsertionDualWristDataConfig,
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_maniskill_peg_insertion",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False
        ),
        data=LeRobotManiSkillPegInsertionDataConfig(
            repo_id="physical-intelligence/maniskill",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(assets_dir="checkpoints/torch/pi05_maniskill/assets"),
            extra_delta_transform=False,
    ...
    TrainConfig(
        ...
        data=LeRobotManiSkillPegInsertionWristDataConfig(
            repo_id="physical-intelligence/maniskill",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(assets_dir="checkpoints/torch/pi05_maniskill/assets"),
            extra_delta_transform=False,
    ...
    TrainConfig(
        name="pi05_maniskill_peg_insertion_dualwrist",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False
        ),
        data=LeRobotManiSkillPegInsertionDualWristDataConfig(
            repo_id="physical-intelligence/maniskill",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(assets_dir="checkpoints/torch/pi05_maniskill/assets"),
            extra_delta_transform=False,
    ...
    TrainConfig(
        name="pi05_maniskill_peg_insertion_actual_ee",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False
        ),
        data=LeRobotManiSkillPegInsertionWristDataConfig(
